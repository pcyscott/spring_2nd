...
import com.mysite.lect.User.UserService;
...
public class AnswerController {
    ...
    public String createAnswer(Model model, @PathVariable("id") Long id,
                               @Valid AnswerForm answerForm, BindingResult bindingResult, Principal principal) {
        {
            ...
            return String.format("redirect:/question/detail/%s#answer_%s", id,
    ...
    public String answerModify(@Valid AnswerForm answerForm, BindingResult bindingResult, @PathVariable("id")
